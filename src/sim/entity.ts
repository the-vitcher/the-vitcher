...
function baseEntity(id: number, pos: Vec3): Entity {
  return {
    ...
    chargeTargetId: null, chargeTimeLeft: 0, chargePath: [], followTargetId: null, spectateTargetId: null,
    ...
    dead: false, spectator: false, mobaTeam: null, mobaLane: null, scale: 1, color: 0xffffff, skinCatalog: 'class', skin: 0, guild: '',
  };
}
