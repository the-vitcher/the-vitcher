...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "floorTimer": "楼层将在 {time} 后坍塌",
    "crawlRun": "第 {run}/{total} 轮，{time} 后重置",
    "spectator": {
      "watching": "正在观战",
      "prev": "上一位爬行者",
      "next": "下一位爬行者",
  ...
  "entities": {
    ...
    "dungeons": {
      ...
      "crawl_floor_1": {
        "name": "地城爬行：第1层，新手引导",
        "enterText": "第1层。镜头已经开播。升级，找到向下的楼梯，尽量别在头一分钟里就死掉。",
        "leaveText": "你向着那座已不复存在的地表，重新往上攀爬。"
      },
      "crawl_floor_2": {
        "name": "地城爬行：第2层，不眠死者",
        "enterText": "第2层。旧住户都爬起来走动了。在一层楼上逗留太久，是个送命的好办法。",
        "leaveText": "你退回楼梯，向上撤离。"
      },
      "crawl_floor_3": {
        "name": "地城爬行：第3层，空巢墓窟",
        "enterText": "第3层。制作人在这下面养了只宠物，而且从不分享。先升几级，再去敲门。",
        "leaveText": "趁还能脱身，你退出了墓窟。"
      },
      "crawl_floor_4": {
        "name": "地城爬行：第4层，溺亡军列",
        "enterText": "第4层。冰冷的水，更冷的死者，还有一位对来客很有意见的女主持。",
        "leaveText": "你从溺亡的黑暗中重新涉水而上。"
      },
      "crawl_floor_5": {
        "name": "地城爬行：第5层，迷雾窟巢",
        "enterText": "第5层。迷雾之锚把雾气拽进来，而雾气又拽来援军。观众最爱援军了。",
        "leaveText": "你在渐渐稀薄的迷雾里摸索着向上。"
      },
      "crawl_floor_6": {
        "name": "地城爬行：第6层，骨匠长厅",
        "enterText": "第6层。头牌科尔德斯只是下方真正大戏的暖场。先把等级练够。",
        "leaveText": "你沿着骨匠的阶梯，奋力向上攀回。"
      },
      "crawl_floor_7": {
        "name": "地城爬行：第7层，节目总监的密库",
        "enterText": "最底层。节目总监盘踞在巨大的祭坛上，整个银河都在观看。再没有向下的楼梯了。",
        "leaveText": "你背对祭坛，开始向上攀登。"
      },
      "crawl_guide_room": {
        "name": "地城爬行：向导室",
        "enterText": "欢迎来到地城爬行。这是一间安全屋，所以这里没有人会死，包括你。找到你的向导，听他把话讲完，准备好了就走下面的楼梯。",
        "leaveText": "你重新走出去，朝着那座已不复存在的地表。"
      }
    }
  },
  "worldContent": {
