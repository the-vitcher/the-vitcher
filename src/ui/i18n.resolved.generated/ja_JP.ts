...
export const ja_JP: EnTranslations = {
  ...
  "entities": {
    ...
    "dungeons": {
      ...
      "crawl_floor_1": {
        "name": "クロウル：1階、オリエンテーション",
        "enterText": "1階。カメラは生放送中。レベルを上げ、下りの階段を見つけ、最初の1分で死なないようにしろ。",
        "leaveText": "あなたは、もはや存在しない地上へと再び登っていく。"
      },
      "crawl_floor_2": {
        "name": "クロウル：2階、安らがぬ死者",
        "enterText": "2階。かつての住人たちが起き上がって歩き回っている。一つの階に長居するのは、そこで死ぬ近道だ。",
        "leaveText": "あなたは階段を引き返し、上へと退く。"
      },
      "crawl_floor_3": {
        "name": "クロウル：3階、虚ろの納骨堂",
        "enterText": "3階。プロデューサーがここでペットを飼っていて、分け前は渡さない。まず数レベル上げてから、戸を叩け。",
        "leaveText": "まだ抜け出せるうちに、あなたは納骨堂から後ずさる。"
      },
      "crawl_floor_4": {
        "name": "クロウル：4階、溺れし軍列",
        "enterText": "4階。冷たい水、もっと冷たい死者、そして来訪者にうるさい司会者。",
        "leaveText": "あなたは溺れる闇の中から、再び水をかき分けて登る。"
      },
      "crawl_floor_5": {
        "name": "クロウル：5階、霧の巣窟",
        "enterText": "5階。霧のアンカーが霧を引き込み、霧が増援を引き込む。観客は増援が大好きだ。",
        "leaveText": "あなたは薄れゆく霧の中を、手探りで上へ進む。"
      },
      "crawl_floor_6": {
        "name": "クロウル：6階、骨細工の大広間",
        "enterText": "6階。主役コルデスは、下に待つ本番の前座にすぎない。ふさわしいレベルになっておけ。",
        "leaveText": "あなたは骨細工の階段を、苦労して上へと登り返す。"
      },
      "crawl_floor_7": {
        "name": "クロウル：7階、ショーランナーの宝庫",
        "enterText": "最下層。ショーランナーが大祭壇に陣取り、銀河じゅうが見ている。もう下りの階段はない。",
        "leaveText": "あなたは祭壇に背を向け、登りはじめる。"
      },
      "crawl_guide_room": {
        "name": "クロウル：ガイド室",
        "enterText": "クロウルへようこそ。ここは安全地帯だから、何も死なない、君も含めてな。ガイドを見つけ、話を最後まで聞き、準備ができたら下りの階段を使え。",
        "leaveText": "君は、もはや存在しない地上へと再び出ていく。"
      }
    }
  },
  "worldContent": {
