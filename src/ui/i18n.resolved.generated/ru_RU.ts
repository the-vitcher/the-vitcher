  ...
  "entities": {
    ...
    "items": {
      ...
      "moba_sharpened_pencil": {
        "name": "Карандаш Номер Два (Заточенный)"
      },
      "moba_wand_of_inconvenience": {
        "name": "Жезл Лёгкого Неудобства"
      },
      "moba_suspicious_spoon": {
        "name": "Подозрительно Большая Ложка"
      },
      "moba_hr_violation": {
        "name": "Заверенное Нарушение Кадровой Политики"
      },
      "moba_bubble_wrap_cuirass": {
        "name": "Кираса из Пузырчатой Плёнки"
      },
      "moba_traffic_cone": {
        "name": "Дорожный Конус Власти"
      },
      "moba_oven_mitts": {
        "name": "Прихватки Ловкого Обращения"
      },
      "moba_foam_clogs": {
        "name": "Пенные Сабо Ослепительной Скорости"
      },
      "moba_cargo_shorts": {
        "name": "Карго-Шорты Вместимости"
      },
      "moba_tactical_fanny_pack": {
        "name": "Тактическая Поясная Сумка"
      },
      "moba_shoulder_parrot": {
        "name": "Плечевой Попугай (Чучело)"
      },
      "moba_executive_bathrobe": {
        "name": "Директорский Халат"
      },
      "moba_reading_glasses": {
        "name": "Бабушкины Очки для Чтения"
      },
      "moba_support_brick": {
        "name": "Кирпич Эмоциональной Поддержки"
      },
      "briny_idol": {
    ...
    "mobs": {
      ...
      "moba_minion_melee": {
        "name": "Пехотинец линии"
      },
      "moba_minion_ranged": {
        "name": "Заклинатель линии"
      },
      "moba_tower": {
        "name": "Защитная башня"
      },
    ...
    "npcs": {
      ...
      "crawl_guide_sotreel": {
        "name": "Сотрил",
        "title": "Связной 9-го уровня",
        "greeting": "Краулер. Я Сотрил, связной девятого уровня, и да, мне выпал короткий жребий. Коротко, потому что здесь всё на таймере: твой мир пустили под застройку, и теперь ты участник Спуска, прямой трансляции, на которую ставит вся галактика. Ниже ещё много этажей, каждый смертоноснее предыдущего. Убивай тварей, забирай их уровни, ищи лестницу вниз и не будь скучным, потому что зрители платят за дерзких. Одобрение — единственная валюта, которая покупает выход, так что держись рядом с отрядом и старайся быть достойным зрелища. Лестница в глубине зала. Удачи. Мне платят, когда ты выживаешь."
      },
      "moba_shopkeeper": {
        "name": "Двасумка",
        "title": "Совершенно Точно Лицензированный Торговец",
        "greeting": "Добро пожаловать! У Двасумки есть всё, что нужно герою: лопатки, конусы, кирпичи, сомнительные бумаги. Все продажи окончательны, весь товар кем-то сертифицирован. Золото вперёд, слава потом!"
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "dungeons": {
      ...
      "moba_lane": {
        "name": "Столкновение: линия Железной твердыни",
        "enterText": "Добро пожаловать в Столкновение. Продвигайте линию, уничтожайте вражеские башни и разбейте ядро противника раньше, чем они разобьют ваше.",
        "leaveText": "Вы отступаете с линии."
      },
      "drowned_temple": {
        "name": "Утонувший храм",
      ...
      "crawl_floor_3": {
        ...
        "enterText": "Этаж 3. Продюсер держит здесь питомца и ничем не делится. Сначала возьми пару уровней, а потом стучись.",
        "leaveText": "Пока ещё можешь, ты пятишься прочь из крипты."
      },
      "crawl_floor_4": {
        "name": "Спуск: Этаж 4, Утонувшие ряды",
        "enterText": "Этаж 4. Холодная вода, мертвецы ещё холоднее, и Ведущая, у которой есть мнение о гостях.",
        "leaveText": "Ты снова выбираешься вброд из тонущей тьмы."
      },
      "crawl_floor_5": {
        "name": "Спуск: Этаж 5, Туманные норы",
        "enterText": "Этаж 5. Якорь Тумана затягивает туман, а туман затягивает подкрепления. Зрители обожают подкрепления.",
        "leaveText": "Ты на ощупь поднимаешься сквозь редеющий туман."
      },
      "crawl_floor_6": {
        "name": "Спуск: Этаж 6, Залы костодела",
        "enterText": "Этаж 6. Кордет Хедлайнер лишь разогрев перед тем, что ждёт внизу. Дорасти до нужного уровня.",
        "leaveText": "Ты с трудом карабкаешься обратно вверх по лестнице костодела."
      },
      "crawl_floor_7": {
        "name": "Спуск: Этаж 7, Хранилище шоураннера",
        "enterText": "Самый нижний этаж. Шоураннер восседает на огромном алтаре, и вся галактика смотрит. Лестниц вниз больше нет.",
        "leaveText": "Ты поворачиваешься спиной к алтарю и начинаешь подъём."
      },
      "crawl_guide_room": {
        "name": "Спуск: Комната гида",
        "enterText": "Добро пожаловать на Спуск. Это безопасная комната, так что здесь никто не умирает, включая тебя. Найди своего гида, выслушай его и спускайся по лестнице, когда будешь готов.",
        "leaveText": "Ты снова выходишь наружу, к поверхности, которой больше нет."
      }
    }
  },
  "worldContent": {
