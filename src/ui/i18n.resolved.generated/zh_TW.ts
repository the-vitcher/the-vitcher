...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "moba": {
      ...
      "learn": "學習",
      "upgrade": "升級",
      "skillPoints": "技能點：{count}",
      "ultLocked": "等級 {level} 解鎖",
      "recall": "回城",
      "recallChanneling": "回城中……{seconds}秒",
      "recallCooldown": "回城冷卻 {seconds}秒",
      "respawnIn": "{seconds}秒後復活",
      "victory": "勝利",
      "defeat": "失敗",
      "tooltip": {
        "rank": "等級 {rank}/{max}",
        "notLearned": "尚未學習 - 花費一個技能點解鎖",
        "nextRank": "下一級：{value}",
        "ultimate": "終極技能 - 英雄等級 {level} 解鎖"
      },
      "roles": {
        "bruiser": "鬥士",
        "assassin": "刺客",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "crawl_guide_sotreel": {
        "name": "索特里爾",
        "title": "九級聯絡員",
        "greeting": "爬塔者。我是索特里爾，九級聯絡員，沒錯，我抽到了下下籤。長話短說，因為這下面的一切都有計時：你的世界被重新開發了，如今你是地城爬行的參賽者，一場全銀河都在押注的現場直播。下面還有許多層，一層比一層致命。殺怪、奪取牠們的等級、找到向下的樓梯，別讓自己變得無聊，因為觀眾只為大膽買單。人氣是唯一能買來活路的貨幣，所以別離隊太遠，爭取讓自己值得一看。樓梯在後面。祝你好運。你活著，我才有錢拿。"
      },
      "moba_shopkeeper": {
        "name": "雙袋子",
        "title": "絕對持證商人",
        "greeting": "歡迎歡迎！雙袋子這裡應有盡有：鍋鏟、路錐、磚頭、來路存疑的文書。所有交易概不退換，所有商品都經過某人認證。先交金幣，後得榮耀！"
      },
      "tidewatcher_ondrel": {
        "name": "翁德瑞爾·韋恩",
        "title": "守潮者",
    ...
    "dungeons": {
      ...
      "moba_lane": {
        "name": "對決：鐵壁兵線",
        "enterText": "歡迎來到對決。推進兵線，摧毀敵方防禦塔，在對手擊碎你的核心之前先擊碎他們的核心。",
        "leaveText": "你從兵線上撤退。"
      },
      "drowned_temple": {
        "name": "溺亡神殿",
      ...
      "crawl_floor_3": {
        "name": "地城爬行：第3層，空巢墓窟",
        "enterText": "第3層。製作人在這下面養了隻寵物，而且從不分享。先升幾級，再去敲門。",
        "leaveText": "趁還能脫身，你退出了墓窟。"
      },
      "crawl_floor_4": {
        "name": "地城爬行：第4層，溺亡軍列",
        "enterText": "第4層。冰冷的水，更冷的死者，還有一位對來客很有意見的女主持。",
        "leaveText": "你從溺亡的黑暗中重新涉水而上。"
      },
      "crawl_floor_5": {
        "name": "地城爬行：第5層，迷霧窟巢",
        "enterText": "第5層。迷霧之錨把霧氣拽進來，而霧氣又拽來援軍。觀眾最愛援軍了。",
        "leaveText": "你在漸漸稀薄的迷霧裡摸索著向上。"
      },
      "crawl_floor_6": {
        "name": "地城爬行：第6層，骨匠長廳",
        "enterText": "第6層。頭牌科爾德斯只是下方真正大戲的暖場。先把等級練夠。",
        "leaveText": "你沿著骨匠的階梯，奮力向上攀回。"
      },
      "crawl_floor_7": {
        "name": "地城爬行：第7層，節目總監的密庫",
        "enterText": "最底層。節目總監盤踞在巨大的祭壇上，整個銀河都在觀看。再沒有向下的樓梯了。",
        "leaveText": "你背對祭壇，開始向上攀登。"
      },
      "crawl_guide_room": {
        "name": "地城爬行：嚮導室",
        "enterText": "歡迎來到地城爬行。這是一間安全屋，所以這裡沒有人會死，包括你。找到你的嚮導，聽他把話講完，準備好了就走下面的樓梯。",
        "leaveText": "你重新走出去，朝著那座已不復存在的地表。"
      }
    }
  },
  "worldContent": {
