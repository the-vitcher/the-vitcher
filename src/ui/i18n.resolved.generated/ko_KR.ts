...
export const ko_KR: EnTranslations = {
  ...
  "entities": {
    ...
    "dungeons": {
      ...
      "crawl_floor_3": {
        "name": "크롤: 3층, 텅 빈 납골당",
        "enterText": "3층. 프로듀서가 이 아래에서 애완동물을 기르며, 결코 나누지 않는다. 먼저 몇 레벨 올린 뒤에 문을 두드려라.",
        "leaveText": "아직 빠져나갈 수 있을 때, 당신은 납골당에서 물러난다."
      },
      "crawl_floor_4": {
        "name": "크롤: 4층, 익사한 대열",
        "enterText": "4층. 차가운 물, 더 차가운 사자, 그리고 방문객에게 할 말이 많은 진행자.",
        "leaveText": "당신은 익사의 어둠 속에서 다시 물을 헤치며 올라간다."
      },
      "crawl_floor_5": {
        "name": "크롤: 5층, 안개 굴",
        "enterText": "5층. 안개의 닻이 안개를 끌어들이고, 안개가 증원을 끌어들인다. 관객은 증원을 무척 좋아한다.",
        "leaveText": "당신은 옅어지는 안개 속을 더듬으며 위로 나아간다."
      },
      "crawl_floor_6": {
        "name": "크롤: 6층, 뼈장이의 대전당",
        "enterText": "6층. 헤드라이너 코르데스는 아래에서 기다리는 본 무대의 몸풀기에 불과하다. 적정 레벨을 맞춰 두어라.",
        "leaveText": "당신은 뼈장이의 계단을 힘겹게 다시 기어오른다."
      },
      "crawl_floor_7": {
        "name": "크롤: 7층, 쇼러너의 보물고",
        "enterText": "최하층. 쇼러너가 거대한 제단에 자리 잡고 있으며, 온 은하가 지켜보고 있다. 더 이상 내려가는 계단은 없다.",
        "leaveText": "당신은 제단에 등을 돌리고 오르기 시작한다."
      },
      "crawl_guide_room": {
        "name": "크롤: 가이드 룸",
        "enterText": "크롤에 온 걸 환영한다. 여기는 안전 구역이라 아무것도 죽지 않는다, 너를 포함해서. 가이드를 찾아 이야기를 끝까지 듣고, 준비되면 아래로 내려가는 계단을 이용해라.",
        "leaveText": "당신은 더 이상 존재하지 않는 지상을 향해 다시 걸어 나간다."
      }
    }
  },
  "worldContent": {
