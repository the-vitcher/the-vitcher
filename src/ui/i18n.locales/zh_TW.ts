...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.dungeons.crawl_floor_1.name": "地城爬行：第1層，新手引導",
  "entities.dungeons.crawl_floor_1.enterText": "第1層。鏡頭已經開播。升級，找到向下的樓梯，盡量別在頭一分鐘就死掉。",
  "entities.dungeons.crawl_floor_1.leaveText": "你向著那座已不復存在的地表，重新往上攀爬。",
  "entities.dungeons.crawl_floor_2.name": "地城爬行：第2層，不眠死者",
  "entities.dungeons.crawl_floor_2.enterText": "第2層。舊住戶都爬起來走動了。在一層樓上逗留太久，是個送命的好辦法。",
  "entities.dungeons.crawl_floor_2.leaveText": "你退回樓梯，向上撤離。",
  "entities.dungeons.crawl_floor_3.name": "地城爬行：第3層，空巢墓窟",
  "entities.dungeons.crawl_floor_3.enterText": "第3層。製作人在這下面養了隻寵物，而且從不分享。先升幾級，再去敲門。",
  "entities.dungeons.crawl_floor_3.leaveText": "趁還能脫身，你退出了墓窟。",
  "entities.dungeons.crawl_floor_4.name": "地城爬行：第4層，溺亡軍列",
  "entities.dungeons.crawl_floor_4.enterText": "第4層。冰冷的水，更冷的死者，還有一位對來客很有意見的女主持。",
  "entities.dungeons.crawl_floor_4.leaveText": "你從溺亡的黑暗中重新涉水而上。",
  "entities.dungeons.crawl_floor_5.name": "地城爬行：第5層，迷霧窟巢",
  "entities.dungeons.crawl_floor_5.enterText": "第5層。迷霧之錨把霧氣拽進來，而霧氣又拽來援軍。觀眾最愛援軍了。",
  "entities.dungeons.crawl_floor_5.leaveText": "你在漸漸稀薄的迷霧裡摸索著向上。",
  "entities.dungeons.crawl_floor_6.name": "地城爬行：第6層，骨匠長廳",
  "entities.dungeons.crawl_floor_6.enterText": "第6層。頭牌科爾德斯只是下方真正大戲的暖場。先把等級練夠。",
  "entities.dungeons.crawl_floor_6.leaveText": "你沿著骨匠的階梯，奮力向上攀回。",
  "entities.dungeons.crawl_floor_7.name": "地城爬行：第7層，節目總監的密庫",
  "entities.dungeons.crawl_floor_7.enterText": "最底層。節目總監盤踞在巨大的祭壇上，整個銀河都在觀看。再沒有向下的樓梯了。",
  "entities.dungeons.crawl_floor_7.leaveText": "你背對祭壇，開始向上攀登。",
  "entities.dungeons.crawl_guide_room.name": "地城爬行：嚮導室",
  "entities.dungeons.crawl_guide_room.enterText": "歡迎來到地城爬行。這是一間安全屋，所以這裡沒有人會死，包括你。找到你的嚮導，聽他把話講完，準備好了就走下面的樓梯。",
  "entities.dungeons.crawl_guide_room.leaveText": "你重新走出去，朝著那座已不復存在的地表。",
  "entities.mobs.moba_minion_melee.name": "兵線步兵",
  ...
  "entities.mobs.moba_creep_vendbot.name": "自動販賣魔",
  "entities.dungeons.moba_lane.name": "對決：鐵壁兵線",
  "entities.dungeons.moba_lane.enterText": "歡迎來到對決。推進兵線，摧毀敵方防禦塔，在對手擊碎你的核心之前先擊碎他們的核心。",
  "entities.dungeons.moba_lane.leaveText": "你從兵線上撤退。",
  "hudChrome.floorTimer": "樓層將在 {time} 後坍塌",
  "hudChrome.crawlRun": "第 {run}/{total} 輪，{time} 後重置",
  "hudChrome.spectator.watching": "正在觀戰",
  ...
  "hudChrome.clash.joinLive": "加入戰鬥",
  "hudChrome.clash.lobbyEmpty": "還沒有房間，建立一個並召集好友吧！",
  "hudChrome.clash.lobbyPlayers": "{joined}/{capacity} 名玩家",
  "hudChrome.clash.hostedBy": "{name} 的房間",
  "hudChrome.clash.join": "加入",
  "hudChrome.clash.leave": "離開",
  "hudChrome.clash.startNow": "立即開始",
  "hudChrome.moba.heroSelectTitle": "選擇你的英雄",
  "hudChrome.moba.changeHero": "更換英雄",
  "hudChrome.moba.warmup": "對決即將開始",
  "hudChrome.moba.status": "防禦塔 {a} : {b}  |  {time}",
  "hudChrome.moba.learn": "學習",
  "hudChrome.moba.upgrade": "升級",
  "hudChrome.moba.skillPoints": "技能點：{count}",
  "hudChrome.moba.ultLocked": "等級 {level} 解鎖",
  "hudChrome.moba.recall": "回城",
  "hudChrome.moba.recallChanneling": "回城中……{seconds}秒",
  "hudChrome.moba.recallCooldown": "回城冷卻 {seconds}秒",
  "hudChrome.moba.respawnIn": "{seconds}秒後復活",
  "hudChrome.moba.victory": "勝利",
  "hudChrome.moba.defeat": "失敗",
  ...
  "hudChrome.moba.roles.mage": "法師",
  "hudChrome.moba.roles.support": "輔助",
  "entities.npcs.crawl_guide_sotreel.name": "索特里爾",
  "entities.npcs.crawl_guide_sotreel.title": "九級聯絡員",
  "entities.npcs.crawl_guide_sotreel.greeting": "爬塔者。我是索特里爾，九級聯絡員，沒錯，我抽到了下下籤。長話短說，因為這下面的一切都有計時：你的世界被重新開發了，如今你是地城爬行的參賽者，一場全銀河都在押注的現場直播。下面還有許多層，一層比一層致命。殺怪、奪取牠們的等級、找到向下的樓梯，別讓自己變得無聊，因為觀眾只為大膽買單。人氣是唯一能買來活路的貨幣，所以別離隊太遠，爭取讓自己值得一看。樓梯在後面。祝你好運。你活著，我才有錢拿。",
  "entities.mobs.crawl_tutorial_grub.name": "教學幼蟲",
  "entities.mobs.crawl_spectator_drone.name": "觀眾無人機",
  "entities.mobs.crawl_alley_skitterling.name": "巷弄爬蟲",
  "entities.mobs.crawl_husk_tenant.name": "空殼住戶",
  "entities.mobs.crawl_spark_hound.name": "電火獵犬",
  "entities.mobs.crawl_stitched_meatgolem.name": "縫合血肉傀儡",
  "entities.mobs.crawl_rust_revenant.name": "鏽蝕亡魂",
  "entities.mobs.crawl_static_wraith.name": "靜電怨靈",
  "entities.mobs.crawl_chrome_zealot.name": "鉻鋼狂徒",
  "entities.mobs.crawl_ratings_horror.name": "收視恐魔",
  "entities.mobs.crawl_boss_gnasher.name": "啃咬者，一層的寵兒",
  "entities.mobs.crawl_boss_vurmix.name": "房東沃爾米克斯",
  "entities.mobs.crawl_boss_producers_pet.name": "製作人的寵物",
  "entities.mobs.crawl_boss_mortdecai.name": "女主持莫德凱",
  "entities.mobs.crawl_boss_mist_anchor.name": "迷霧之錨",
  "entities.mobs.crawl_boss_kordeth.name": "頭牌科爾德斯",
  "entities.mobs.crawl_boss_showrunner.name": "節目總監",
  "entities.items.crawl_token.name": "爬行代幣",
  "entities.items.gnashers_fang.name": "啃咬者之牙",
  "entities.items.landlords_padded_vest.name": "房東的襯墊背心",
  "entities.items.producers_pet_collar.name": "製作人寵物項圈",
  "entities.items.hostess_long_gloves.name": "女主持的長手套",
  "entities.items.mist_anchor_pauldrons.name": "迷霧之錨護肩",
  "entities.items.headliners_crown.name": "頭牌的冠冕",
  "entities.items.showrunners_gavel.name": "節目總監的木槌",
  "entities.items.moba_spatula_of_smiting.name": "懲戒鍋鏟",
  "entities.items.moba_sharpened_pencil.name": "二號鉛筆（削尖）",
  "entities.items.moba_wand_of_inconvenience.name": "輕度不便魔杖",
  "entities.items.moba_suspicious_spoon.name": "可疑的大湯匙",
  "entities.items.moba_hr_violation.name": "經認證的HR違規",
  "entities.items.moba_bubble_wrap_cuirass.name": "氣泡膜胸甲",
  "entities.items.moba_traffic_cone.name": "權威交通錐",
  "entities.items.moba_oven_mitts.name": "靈巧隔熱手套",
  "entities.items.moba_foam_clogs.name": "致盲疾速泡棉涼鞋",
  "entities.items.moba_cargo_shorts.name": "收納工裝短褲",
  "entities.items.moba_tactical_fanny_pack.name": "戰術腰包",
  "entities.items.moba_shoulder_parrot.name": "肩頭鸚鵡（標本）",
  "entities.items.moba_executive_bathrobe.name": "總裁浴袍",
  "entities.items.moba_reading_glasses.name": "奶奶的老花眼鏡",
  "entities.items.moba_support_brick.name": "情感支持磚頭",
  "entities.npcs.moba_shopkeeper.name": "雙袋子",
  "entities.npcs.moba_shopkeeper.title": "絕對持證商人",
  "entities.npcs.moba_shopkeeper.greeting": "歡迎歡迎！雙袋子這裡應有盡有：鍋鏟、路錐、磚頭、來路存疑的文書。所有交易概不退換，所有商品都經過某人認證。先交金幣，後得榮耀！",
